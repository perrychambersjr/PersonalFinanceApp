...
const WithdrawModal = ({ open, onClose, name, total, goalProgress, theme, target}) => {
  return (
...
{/* Modal Header */ }
            <div className="bg-white rounded-lg p-8 shadow-lg w-1/3">
                <div className="flex flex-row justify-between">
                    <h1 className="text-[var(--grey-900)] text-4xl font-bold">Withdraw from '{name}'</h1>
              ...
              <div className="mt-6"> 
                {/* Progress Bar Header*/ }
                <div className="flex flex-row justify-between">
                  <p className="text-[var(--grey-500)] font-semibold">Amount to Withdraw</p>
              ...
              <div className="grid gap-6 mt-6 w-full">
                <div>
                  <label for="new_amount" className="text-[var(--grey-900)] font-semibold block mb-2 text-sm ">Amount to add</label>
                  ...
                  <button className="text-center bg-[var(--grey-900)] text-white rounded-lg w-full mt-6 h-15 hover:bg-[var(--grey-500)] hover:transition ease-in-out duration-800">Confirm Withdrawal</button>
                </div>
              </div>
             </div>  
    </div>
